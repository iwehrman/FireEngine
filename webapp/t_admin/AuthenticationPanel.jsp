...
try {
	if (at != null)
		rs = AuthenticationService.selectRecent(at, 10);
	else
...
%>
	</table><a href = "<%=pfix%>admin_authentication_all_panel">Show All Users</a> | <a href = "<%=pfix%>admin_authentication_insert_panel">Add New User</a></p>
