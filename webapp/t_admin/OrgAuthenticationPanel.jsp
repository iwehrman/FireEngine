...
%>
	...
	<form method="get" action="<%=context.getVirtualRoot() + servletName%>">
...
try {
	if (at != null)
		rs = OrgAuthenticationService.selectRecent(at, 5);
	else
...
%>
	</table><a href = "<%=pfix%>admin_orgauthentication_all_panel">Show All Organizations</a> | <a href = "<%=pfix%>admin_orgauthentication_insert_panel">Add New Organization</a></p>
